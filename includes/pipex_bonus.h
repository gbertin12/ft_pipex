...
/*   Updated: 2022/08/09 19:45:52 by gbertin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int exec_first_mid_cmd(int fd[2], t_list_bonus *cmd, t_struct *pipex, char *envp[]);
int exec_last_cmd(t_list_bonus *cmd, t_struct *pipex, char *envp[], int fd[2]);
